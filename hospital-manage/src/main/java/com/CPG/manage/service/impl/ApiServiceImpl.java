...
import com.CPG.manage.mapper.HospitalSetMapper;
import com.CPG.manage.mapper.ScheduleMapper;
import com.CPG.manage.model.HospitalSet;
import com.CPG.manage.model.Schedule;
import com.CPG.manage.service.ApiService;
import com.CPG.manage.util.BeanUtils;
import com.CPG.manage.util.HttpRequestHelper;
import com.CPG.manage.util.MD5;
...
public class ApiServiceImpl  implements ApiService {
    ...
    @Override
    public String getHoscode() { HospitalSet hospitalSet = hospitalSetMapper.selectById(1);
    ...
    public boolean saveHospital(String data) {
        ...
        if(null != respone && 200 == respone.getIntValue("code")) {
            ...
            throw new AppointmentRegisterException(respone.getString("message"), 201);
        }
    }
